...
node tests/test_comparador.js              # 86 comprobaciones, careo contra el core y barridos
node tests/test_comparador_3d.js           # 114 comprobaciones, escena 3D, equipos, sizing y barridos
