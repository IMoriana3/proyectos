...
node tests/test_comparador.js              # 82 comprobaciones, careo contra el core y barridos
node tests/test_comparador_3d.js           # 104 comprobaciones, escena 3D, equipos, sizing y barridos
