...
node tests/test_comparador.js              # 201 comprobaciones, careo contra el core y barridos
node tests/test_comparador_3d.js           # 199 comprobaciones, escena 3D, equipos, sizing y barridos
