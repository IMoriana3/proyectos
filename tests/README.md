...
node tests/test_comparador.js              # 84 comprobaciones, careo contra el core y barridos
node tests/test_comparador_3d.js           # 107 comprobaciones, escena 3D, equipos, sizing y barridos
...
node tests/test_layout_ui.js               # 107 comprobaciones, el generador en Chromium
```
