...
node tests/test_comparador_3d.js           # 111 comprobaciones, escena 3D, equipos, sizing y barridos
...
node tests/test_layout_ui.js               # 160 comprobaciones, el generador en Chromium
```
